...
namespace SaleManagementWinApp
{
    public partial class frmOrderList : Form
    {
        ...
        private decimal? totalAllOrders;
        ...
        private void LoadOrderList()
        {
            if (Customer != null)
            {
                var customerOrders = orderRepository.GetAllOrders()
                    .Where(c => c.CustomerId == Customer.CustomerId)
                    .ToList();

                dgvOrder.DataSource = customerOrders.Select(c => new
                {
                    c.OrderId,
                ...
                totalAllOrders = customerOrders.Sum(c => c.Total);
                txttotalAllOrders.Text = totalAllOrders.ToString();
            }
            else if (isAdmin)
            {
                ...
                dgvOrder.DataSource = allOrders.Select(c => new
                {
                    c.OrderId,
                    c.Customer.CustomerName,
                    c.OrderDate,
                ...
                totalAllOrders = allOrders.Sum(c => c.Total);
                txttotalAllOrders.Text = totalAllOrders.ToString();
            }
            else
            {
                // Clear DataGridView if neither admin nor customer is logged in
                dgvOrder.DataSource = null;
                txttotalAllOrders.Text = string.Empty;
            }
        }
